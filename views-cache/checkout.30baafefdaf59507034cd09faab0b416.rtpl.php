								...
								<div class="col-md-12">
									...
									<div class="woocommerce-billing-fields">
										...
										<p id="billing_number_1_field" class="form-row form-row-wide number-field validate-required">
											...
											<input type="text" value="<?php echo htmlspecialchars( $address["desnumber"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" placeholder="Número (Obrigatório)" id="billing_address_1" name="desnumber" class="input-text ">
										</p>
